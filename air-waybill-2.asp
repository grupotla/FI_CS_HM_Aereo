...
lineData = Replace(lineData,"<!--La siguiente información se generó mediante el Asistente para publicar como","")
lineData = Replace(lineData,"página web de Microsoft Excel.-->","")
lineData = Replace(lineData,"<!--Si se vuelve a publicar el mismo elemento desde Excel, se reemplazará toda","")
lineData = Replace(lineData,"la información comprendida entre las etiquetas DIV.-->","")
lineData = Replace(lineData,"<!----------------------------->","")
lineData = Replace(lineData,"<!--INICIO DE LOS RESULTADOS DEL ASISTENTE PARA PUBLICAR COMO PÁGINA WEB DE","")
lineData = Replace(lineData,"EXCEL -->","")
'<!----------------------------->


'<!----------------------------->
lineData = Replace(lineData,"<!--FINAL DE LOS RESULTADOS DEL ASISTENTE PARA PUBLICAR COMO PÁGINA WEB DE","")'
lineData = Replace(lineData,"EXCEL-->","")
'<!----------------------------->
