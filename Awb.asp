...
Dim CarrierIDAnt, AWBNumberAnt, HAWBNumberAnt, GuidesAWBNumber, facturar_a, facturar_a_nombre
Dim TipoMaster, TipoHouse, routing_seg, routing_adu, routing_ter, replica, a, b, Conn2, No, TipoCarga2, iConta
Dim ArrAwbType, BtnMaster2, couStr, couStr2, Airports2, iAirportToCode, iAirportFromCode, BtnReplica2, AirportDesID2, AirportDepID2, Transportista2, Country2, Country3, ObjectID2, BtnHouse2, HAWBNumber2, Piezas2, Peso2, Peso2Anterior, Routing2, HAWBNumberTipo2
		...
		<table width="100%" border="1" cellpadding="2" cellspacing="0" align="center">
		 <tr>
			<td class="style4" align="center">
                ...
                <label class=label align=center>Tipo Carga : </label>
		 ...
		 <tr>		
			<td width="488" align="center" class="style4">


			<table width="100%" border="0">
			<tr>
                <td align="center" class="menu activeMain">Cliente</td>
...
<!-- 2022-04-20			se traslada para aca el codigo de air freight por orden y mejor entendimiento-->
			...
			<tr>
                <td align="left" class="style4" nowrap>
				    <input type="text" size="5" class="style10" name="TCAF_CLI" readonly>
				    <input type="text" size="15" class="style10" name="TCAF_CNO" readonly>
			    </td>
                ...
                <td></td>
                <td align="right" class="style4">
				    <input type="text" size="25" class="style10" name="TCAF_FAC" value="" readonly>
			    </td>
                <td align="left" class="style4">
				    <div id="TCAF_STATFAC" name="TCAF_STATFAC" style="VISIBILITY: visible;white-space:nowrap"></div>
			    </td>
			</tr>

			<tr>
                <td align="left" class="style4" nowrap>
				    <input type="text" size="5" class="style10" name="TCTF_CLI" readonly>
				    <input type="text" size="15" class="style10" name="TCTF_CNO" readonly>
			    </td>
                <td align="right" class="style4" bgcolor="#999999">				
				...
				<td align="right" class="style4" bgcolor="#999999">
					<div id="DETF" style="VISIBILITY: hidden;">
					<% If TerminalFee_Routing = "1" Then %>
					<% else %>
                ...
                <td align="right" class="style4">
				    <input type="text" size="25" class="style10" name="TCTF_FAC" value="" readonly>
			    </td>
                <td align="left" class="style4">
				    <div id="TCTF_STATFAC" name="TCTF_STATFAC" style="VISIBILITY: visible;white-space:nowrap"></div>
			    </td>
			</tr>
			<tr>
                <td align="left" class="style4" nowrap>
				    <input type="text" size="5" class="style10" name="TCCF_CLI" readonly>
				    <input type="text" size="15" class="style10" name="TCCF_CNO" readonly>
			    </td>
				<td align="right" class="style4" bgcolor="#999999">
				...
				<td align="right" class="style4" bgcolor="#999999">
					<div id="DECF" style="VISIBILITY: hidden;">
                ...
                <td align="right" class="style4">
				    <input type="text" size="25" class="style10" name="TCCF_FAC" value="" readonly>
			    </td>
                <td align="left" class="style4">
				    <div id="TCCF_STATFAC" name="TCCF_STATFAC" style="VISIBILITY: visible;white-space:nowrap"></div>
			    </td>
			</tr>
			<tr>
                <td align="left" class="style4" nowrap>
				    <input type="text" size="5" class="style10" name="TCFS_CLI" readonly>
				    <input type="text" size="15" class="style10" name="TCFS_CNO" readonly>
			    </td>
                <td align="right" class="style4" bgcolor="#999999">
				...
				<td align="right" class="style4" bgcolor="#999999">
					<div id="DEFS" style="VISIBILITY: hidden;">
                ...
                <td align="right" class="style4">
				    <input type="text" size="25" class="style10" name="TCFS_FAC" value="" readonly>
			    </td>
                <td align="left" class="style4">
				    <div id="TCFS_STATFAC" name="TCFS_STATFAC" style="VISIBILITY: visible;white-space:nowrap"></div>
			    </td>
			</tr>
			<tr>
                <td align="left" class="style4" nowrap>
				    <input type="text" size="5" class="style10" name="TCSF_CLI" readonly>
				    <input type="text" size="15" class="style10" name="TCSF_CNO" readonly>
			    </td>
				<td align="right" class="style4" bgcolor="#999999">				
				...
				<td align="right" class="style4" bgcolor="#999999">
					<div id="DESF" style="VISIBILITY: hidden;">				
					<% If SecurityFee_Routing = "1" Then %>
                ...
                <td align="right" class="style4">
				    <input type="text" size="25" class="style10" name="TCSF_FAC" value="" readonly>
			    </td>
                <td align="left" class="style4">
				    <div id="TCSF_STATFAC" name="TCSF_STATFAC" style="VISIBILITY: visible;white-space:nowrap"></div>
			    </td>
			</tr>
			<tr>
                <td align="left" class="style4" nowrap>
				    <input type="text" size="5" class="style10" name="TCPB_CLI" readonly>
				    <input type="text" size="15" class="style10" name="TCPB_CNO" readonly>
			    </td>
				<td align="right" class="style4" bgcolor="#999999">				
				...
				<td align="right" class="style4" bgcolor="#999999">
					<div id="DEPB" style="VISIBILITY: hidden;">
                ...
                <td align="right" class="style4">
				    <input type="text" size="25" class="style10" name="TCPB_FAC" value="" readonly>
			    </td>
                <td align="left" class="style4">
				    <div id="TCPB_STATFAC" name="TCPB_STATFAC" style="VISIBILITY: visible;white-space:nowrap"></div>
			    </td>
			</tr>
			<tr>
                <td align="left" class="style4" nowrap>
				    <input type="text" size="5" class="style10" name="TCTX_CLI" readonly>
				    <input type="text" size="15" class="style10" name="TCTX_CNO" readonly>
			    </td>
				<td align="right" class="style4" bgcolor="#999999">
				...
				<td align="right" class="style4" bgcolor="#999999">
					<div id="DETX" style="VISIBILITY: hidden;">
                ...
                <td align="right" class="style4">
				    <input type="text" size="25" class="style10" name="TCTX_FAC" value="" readonly>
			    </td>
                <td align="left" class="style4">
				    <div id="TCTX_STATFAC" name="TCTX_STATFAC" style="VISIBILITY: visible;white-space:nowrap"></div>
			    </td>
			</tr>

			<tr>
                <td align="left" class="style4" nowrap>
				    <input type="text" size="5" class="style10" name="TCPU_CLI" readonly>
				    <input type="text" size="15" class="style10" name="TCPU_CNO" readonly>
			    </td>
				<td align="right" class="style4" bgcolor="#999999">				
				...
				<td align="right" class="style4" bgcolor="#999999">
					<div id="DEPU" style="VISIBILITY: hidden;">
                ...
                <td align="right" class="style4">
				    <input type="text" size="25" class="style10" name="TCPU_FAC" value="" readonly>
			    </td>
                <td align="left" class="style4">
				    <div id="TCPU_STATFAC" name="TCPU_STATFAC" style="VISIBILITY: visible;white-space:nowrap"></div>
			    </td>
			</tr>
			<tr>
                <td align="left" class="style4" nowrap>
				    <input type="text" size="5" class="style10" name="TCIM_CLI" readonly>
				    <input type="text" size="15" class="style10" name="TCIM_CNO" readonly>
			    </td>
				<td align="right" class="style4" bgcolor="#999999">					
				...
				<td align="right" class="style4" bgcolor="#999999">
					<div id="DEIM" style="VISIBILITY: hidden;">
                ...
                <td align="right" class="style4">
				    <input type="text" size="25" class="style10" name="TCIM_FAC" value="" readonly>
			    </td>
                <td align="left" class="style4">
				    <div id="TCIM_STATFAC" name="TCIM_STATFAC" style="VISIBILITY: visible;white-space:nowrap"></div>
			    </td>
            </tr>
			<tr>
                <td align="left" class="style4" nowrap>
				    <input type="text" size="5" class="style10" name="TCFF_CLI" readonly>
				    <input type="text" size="15" class="style10" name="TCFF_CNO" readonly>
			    </td>
				<td align="right" class="style4" bgcolor="#999999">
				...
				<td align="right" class="style4" bgcolor="#999999">
					<div id="DEFF" style="VISIBILITY: hidden;">
                ...
                <td align="right" class="style4">
				    <input type="text" size="25" class="style10" name="TCFF_FAC" value="" readonly>
			    </td>
                <td align="left" class="style4">
				    <div id="TCFF_STATFAC" name="TCFF_STATFAC" style="VISIBILITY: visible;white-space:nowrap"></div>
			    </td>
            </tr>
			...
			<tr>
				...
				<% If AdditionalChargeName1_Routing = "1" Then %>            
					...
					<td align="right" class="style4"><div id=DRA1 style="VISIBILITY: hidden;"></div></td>
					<td align="right" class="style4" bgcolor="#999999">
				...
				<% Else %>
					<td align="right" class="style4">
						<div id=DRA1 style="VISIBILITY: hidden;">
				...
				<td align="right" class="style4" bgcolor="#999999">
				<div id=DEA1 style="VISIBILITY: hidden;">
				<% If AdditionalChargeName1_Routing = "1" Then %>
			...
			<tr>
				...
				<% If AdditionalChargeName2_Routing = "1" Then %>            
					...
					<td align="right" class="style4"><div id=DRA2 style="VISIBILITY: hidden;"></div></td>
					<td align="right" class="style4" bgcolor="#999999">
				...
				<% Else %>		
					<td align="right" class="style4">
						<div id=DRA2 style="VISIBILITY: hidden;">
				...
				<td align="right" class="style4" bgcolor="#999999">
				<div id=DEA2 style="VISIBILITY: hidden;">				
				<% If AdditionalChargeName2_Routing = "1" Then %>
			...
			<tr>
				...
				<% If AdditionalChargeName6_Routing = "1" Then %>            
					...
					<td align="right" class="style4"><div id=DRA3 style="VISIBILITY: hidden;"></div></td>
					<td align="right" class="style4" bgcolor="#999999">
				...
				<% Else %>		
					<td align="right" class="style4">
						<div id=DRA3 style="VISIBILITY: hidden;">
				...
				<td align="right" class="style4" bgcolor="#999999">
				<div id=DEA3 style="VISIBILITY: hidden;">
				<% If AdditionalChargeName6_Routing = "1" Then %>
			...
			<tr>
				...
				<% If AdditionalChargeName7_Routing = "1" Then %>            
					...
					<td align="right" class="style4"><div id=DRA4 style="VISIBILITY: hidden;"></div></td>
					<td align="right" class="style4" bgcolor="#999999">
				...
				<% Else %>		
					<td align="right" class="style4">
						<div id=DRA4 style="VISIBILITY: hidden;">
				...
				<td align="right" class="style4" bgcolor="#999999">
				<div id=DEA4 style="VISIBILITY: hidden;">
				<% If AdditionalChargeName7_Routing = "1" Then %>
			...
			<tr>
				...
				<% If AdditionalChargeName9_Routing = "1" Then %>            
					...
					<td align="right" class="style4"><div id=DRA5 style="VISIBILITY: hidden;"></div></td>
					<td align="right" class="style4" bgcolor="#999999">
				...
				<% Else %>		
					<td align="right" class="style4">
						<div id=DRA5 style="VISIBILITY: hidden;">
				...
				<td align="right" class="style4" bgcolor="#999999">
				<div id=DEA5 style="VISIBILITY: hidden;">
				<% If AdditionalChargeName9_Routing = "1" Then %>
			...
			<tr>
				...
				<% If AdditionalChargeName10_Routing = "1" Then %>            
					...
					<td align="right" class="style4"><div id=DRA6 style="VISIBILITY: hidden;"></div></td>
					<td align="right" class="style4" bgcolor="#999999">
				...
				<% Else %>				
					<td align="right" class="style4">
						<div id=DRA6 style="VISIBILITY: hidden;">
				...
				<td align="right" class="style4" bgcolor="#999999">
				<div id=DEA6 style="VISIBILITY: hidden;">
				<% If AdditionalChargeName10_Routing = "1" Then %>
			...
			<tr>
				...
				<% If AdditionalChargeName11_Routing = "1" Then %>            
					...
					<td align="right" class="style4"><div id=DRA7 style="VISIBILITY: hidden;"></div></td>
					<td align="right" class="style4" bgcolor="#999999">
				...
				<% Else %>			
					<td align="right" class="style4">
						<div id=DRA7 style="VISIBILITY: hidden;">
				...
				<td align="right" class="style4" bgcolor="#999999">
				<div id=DEA7 style="VISIBILITY: hidden;">
				<% If AdditionalChargeName11_Routing = "1" Then %>
			...
			<tr>
				...
				<% Else %>		
					<td align="right" class="style4">
						<div id=DRA8 style="VISIBILITY: hidden;">
				...
				<td align="right" class="style4" bgcolor="#999999">
				<div id=DEA8 style="VISIBILITY: hidden;">
				<% If AdditionalChargeName12_Routing = "1" Then %>
			...
			<tr>
				...
				<% If AdditionalChargeName13_Routing = "1" Then %>            
					...
					<td align="right" class="style4"><div id=DRA9 style="VISIBILITY: hidden;"></div></td>
					<td align="right" class="style4" bgcolor="#999999">
				...
				<% Else %>		
					<td align="right" class="style4">
						<div id=DRA9 style="VISIBILITY: hidden;">
				...
				<td align="right" class="style4" bgcolor="#999999">
				<div id=DEA9 style="VISIBILITY: hidden;">
				<% If AdditionalChargeName13_Routing = "1" Then %>
			...
			<tr>
				...
				<% If AdditionalChargeName14_Routing = "1" Then %>            
					...
					<td align="right" class="style4"><div id=DRA10 style="VISIBILITY: hidden;"></div></td>
					<td align="right" class="style4" bgcolor="#999999">
				...
				<% Else %>		
					<td align="right" class="style4">
						<div id=DRA10 style="VISIBILITY: hidden;">
				...
				<td align="right" class="style4" bgcolor="#999999">
				<div id=DEA10 style="VISIBILITY: hidden;">
				<% If AdditionalChargeName14_Routing = "1" Then %>
			...
			<tr>
				...
				<% If AdditionalChargeName15_Routing = "1" Then %>            
					...
					<td align="right" class="style4"><div id=DRA11 style="VISIBILITY: hidden;"></div></td>
					<td align="right" class="style4" bgcolor="#999999">
				...
				<% Else %>		
					<td align="right" class="style4">
					  <div id=DRA11 style="VISIBILITY: hidden;">
				...
				<td align="right" class="style4" bgcolor="#999999">
				<div id=DEA11 style="VISIBILITY: hidden;">
				<% If AdditionalChargeName15_Routing = "1" Then %>
			...
			<tr>
				...
				<% If AdditionalChargeName3_Routing = "1" Then %>            
					...
					<td align="right" class="style4"><div id=DRC1 style="VISIBILITY: hidden;"></div></td>
					<td align="right" class="style4" bgcolor="#999999">
				...
				<% Else %>		
					<td align="right" class="style4">
						<div id=DRC1 style="VISIBILITY: hidden;">
				...
				<td align="right" class="style4" bgcolor="#999999">
				<div id=DEC1 style="VISIBILITY: hidden;">
				<% If AdditionalChargeName3_Routing = "1" Then %>
			...
			<tr>
				...
				<% If AdditionalChargeName4_Routing = "1" Then %>            
					...
					<td align="right" class="style4"><div id=DRC2 style="VISIBILITY: hidden;"></div></td>
					<td align="right" class="style4" bgcolor="#999999">
				...
				<% Else %>				
					<td align="right" class="style4">
						<div id=DRC2 style="VISIBILITY: hidden;">
				...
				<td align="right" class="style4" bgcolor="#999999">
					<div id=DEC2 style="VISIBILITY: hidden;">	
			...
			<tr>
				...
				<% If AdditionalChargeName5_Routing = "1" Then %>            
					...
					<td align="right" class="style4"><div id=DRC3 style="VISIBILITY: hidden;"></div></td>
					<td align="right" class="style4" bgcolor="#999999">
				...
				<% Else %>						
					<td align="right" class="style4">
						<div id=DRC3 style="VISIBILITY: hidden;">
				...
				<td align="right" class="style4" bgcolor="#999999">
					<div id=DEC3 style="VISIBILITY: hidden;">
				<% If AdditionalChargeName5_Routing = "1" Then %>
			...
			<tr>
				...
				<% If AdditionalChargeName8_Routing = "1" Then %>            
					...
					<td align="right" class="style4"><div id=DRC4 style="VISIBILITY: hidden;"></div></td>
					<td align="right" class="style4" bgcolor="#999999">
				...
				<% Else %>				
					<td align="right" class="style4">
						<div id=DRC4 style="VISIBILITY: hidden;">
				...
				<td align="right" class="style4" bgcolor="#999999">
					<div id=DEC4 style="VISIBILITY: hidden;">								
			   <% If AdditionalChargeName5_Routing = "1" Then %>
  ...
  <tr>
    <td colspan="12" style="border:0px" cellpadding=0 cellspacing=0>
		...
		<tr>
			<td class="style4" align="center" bgcolor="#999999"><input type="text" class="style10" name="TotChargeWeightPrepaid" value="<%=TotChargeWeightPrepaid%>" readonly size="13"></td>
			<td class="style4" align="center" bgcolor="#999999"><input type="text" class="style10" name="TotChargeWeightCollect" value="<%=TotChargeWeightCollect%>" readonly size="13"></td>
