...
<BODY text=#000000 vLink=#000000 aLink=#000000 link=#000000 bgColor=#ffffff leftMargin=0 topMargin=0 marginheight="0" marginwidth="0">
	...
	<INPUT name="CT" type=hidden value="<%=CreatedTime%>">
		...
		<TR><TD class=label align=right><b>Nombre Espa&ntilde;ol:</b></TD><TD class=label align=left><INPUT TYPE=text class=label name="NameES" id="Nombre Español" value="<%=NameES%>" maxlength="60"></TD></TR> 
		...
		<TR><TD class=label align=right><b>Código SCR:</TD><TD class=label align=left><INPUT TYPE=text class=label name="CommodityCode" id="Código SCR" value="<%=CommodityCode%>" maxlength="10"></TD></TR>
		...
		<TR><TD class=label align=right><b>Código Arancel GT:</b></TD><TD class=label align=left><INPUT TYPE=text class=label name="Arancel_GT" id="Código Arancelario Guatemala" value="<%=Arancel_GT%>" maxlength="20"></TD></TR>
		<TR><TD class=label align=right><b>Código Arancel SV:</b></TD><TD class=label align=left><INPUT TYPE=text class=label name="Arancel_SV" id="Código Arancelario El Salvador" value="<%=Arancel_SV%>" maxlength="20"></TD></TR>
		<TR><TD class=label align=right><b>Código Arancel HN:</b></TD><TD class=label align=left><INPUT TYPE=text class=label name="Arancel_HN" id="Código Arancelario Honduras" value="<%=Arancel_HN%>" maxlength="20"></TD></TR>
		<TR><TD class=label align=right><b>Código Arancel NI:</b></TD><TD class=label align=left><INPUT TYPE=text class=label name="Arancel_NI" id="Código Arancelario Nicaragua" value="<%=Arancel_NI%>" maxlength="20"></TD></TR>
		<TR><TD class=label align=right><b>Código Arancel CR:</b></TD><TD class=label align=left><INPUT TYPE=text class=label name="Arancel_CR" id="Código Arancelario Costa Rica" value="<%=Arancel_CR%>" maxlength="20"></TD></TR>
		<TR><TD class=label align=right><b>Código Arancel PA:</b></TD><TD class=label align=left><INPUT TYPE=text class=label name="Arancel_PA" id="Código Arancelario Panama" value="<%=Arancel_PA%>" maxlength="20"></TD></TR>
		<TR><TD class=label align=right><b>Código Arancel BZ:</b></TD><TD class=label align=left><INPUT TYPE=text class=label name="Arancel_BZ" id="Código Arancelario Belice" value="<%=Arancel_BZ%>" maxlength="20"></TD></TR>
		<TR>
