...
if CountTableValues >= 0 then
	...
	ManifestNumber = aTableValues(15, 0)
        flg_master = aTableValues(16, 0)
        flg_totals = aTableValues(17, 0)
...
<SCRIPT LANGUAGE="JavaScript">
	function SetLabelID(Label) {
		...
		if (Label == "ArrivalDate") {
			LabelID = "Fecha de Llegada";
		} else if (Label == "HDepartureDate") {
...
<BODY text=#000000 vLink=#000000 aLink=#000000 link=#000000 bgColor=#ffffff leftMargin=0 topMargin=0 marginheight="0" marginwidth="0">
	...
	<INPUT name="AT" type=hidden value="<%=AwbType%>">
		...
		<INPUT name="Cont"  type=text value="<%=Cont%>" size=23 class=label maxlength="255">
		</TD></TR>
		<TR><TD class=label align=right><b>Destino:</TD><TD class=label align=left>
		<INPUT name="Destinity" type=text value="<%=Destinity%>" size=23 class=label maxlength="255">
		</TD></TR>
		<TR><TD class=label align=right><b>Concepto:</TD><TD class=label align=left>
		<INPUT name="Concept" type=text value="<%=Concept%>" size=23 class=label maxlength="255">
		</TD></TR>
		<TR><TD class=label align=right><b>Almac&eacute;n Fiscal:</TD><TD class=label align=left>
		<INPUT name="FiscalFactory" type=text value="<%=FiscalFactory%>" size=23 class=label maxlength="45">
		</TD></TR>
		<TR><TD class=label align=right><b>Atenci&oacute;n a:</TD><TD class=label align=left>
		<INPUT name="ArrivalAttn" type=text value="<%=ArrivalAttn%>" size=23 class=label maxlength="45">
		</TD></TR>
		<TR><TD class=label align=right><b>Vuelo:</TD><TD class=label align=left>
		<INPUT name="ArrivalFlight" type=text value="<%=ArrivalFlight%>" size=23 class=label maxlength="45">
		</TD></TR>
		...
		<TR><TD class=label align=right><b>No. Manifiesto:</TD><TD class=label align=left>
		<INPUT name="ManifestNumber" type=text value="<%=ManifestNumber%>" size=23 class=label maxlength="45">
		</TD></TR>
