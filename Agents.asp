...
if CountTableValues >= 0 then
	...
	AccountNo = aTableValues(13, 0)
	IATANo = aTableValues(14, 0)
	DefaultVal = CheckNum(aTableValues(15, 0))
end if
...
<BODY text=#000000 vLink=#000000 aLink=#000000 link=#000000 bgColor=#ffffff leftMargin=0 topMargin=0 marginheight="0" marginwidth="0" onLoad="Javascript:self.focus();">
	...
	<INPUT name="CT" type=hidden value="<%=CreatedTime%>">
		...
		<TR><TD class=label align=right><b>No. de Cuenta:</b></TD><TD class=label align=left><INPUT TYPE=text class=label id="Numero de Cuenta" name="AccountNo" value="<%=AccountNo%>" maxlength="45"></TD></TR>
		<TR><TD class=label align=right><b>IATA No.:</b></TD><TD class=label align=left><INPUT TYPE=text class=label id="Código IATA" name="IATANo" value="<%=IATANo%>" maxlength="45"></TD></TR>
		<TR><TD class=label align=right><b>Default:</b></TD><TD class=label align=left><INPUT name=DefaultVal TYPE=checkbox class=label <%If DefaultVal = 1 Then response.write " checked"  End If%>></TD></TR>
